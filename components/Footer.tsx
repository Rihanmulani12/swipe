...
export const  Footer =() => {
  return (
        <footer className="relative bg-white dark:bg-black-100">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-4 gap-8 sm:gap-6 sm:grid-cols-4">
              ...
              <div>
                  ...
                  <ul className="flex flex-col justify-between space-y-4 text-gray-500 dark:text-gray-400 text-sm">
                      ...
                      <li>
                          <a href="#" className="hover:underline">Job</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Swipe</a> <a>Bulid with ❤️ by Rihan Mulani</a>.
          </span>
